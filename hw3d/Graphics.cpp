...
void Graphics::DrawTestTriangle( float angle )
{
	...
	//bind constant buffer to vertex shader in pipeline
...
{
	return "Honey Graphics Exception";
}
...
{
	return "Honey Graphics Exception [Device Removed] (DXGI_ERROR_DEVICE_REMOVED)";
}
...
{
	return "Honey Graphics Info Exception";
}
